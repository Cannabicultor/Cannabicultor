...
(function (global) {
  ...
  function render(el, tipo, id, data) {
    ...
    var copy = tipo === 'growshop'
      ...
      : tipo === 'cbd_shop'
      ? {
          h3: 'Reseñas de clientes',
          empty: 'Aún no hay reseñas de esta tienda. Sé el primero: atención, productos, precios, asesoramiento.',
          ph: '¿Cómo es la atención, los productos y el asesoramiento? (opcional)'
        }
      : {
          h3: 'Reseñas de cultivadores',
